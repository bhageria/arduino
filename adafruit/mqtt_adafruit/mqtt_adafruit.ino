...
#define WLAN_SSID       "Vivek"
#define WLAN_PASS       "HsrAca@7890"

/************************* Adafruit.io Setup *********************************/

#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883                   // use 8883 for SSL
#define AIO_USERNAME    "bhageria"
#define AIO_KEY         "64e20f05ccf24c9fac2e6786cb87099e"
...
void loop() {
  ...
  uint16_t AdcValue = 0;//analogRead(A0);
  if((AdcValue > (potAdcValue + 7)) || (AdcValue < (potAdcValue - 7))){
    potAdcValue = random(0,100);
